...
EXPORT void torusPolynomialClearN(TorusPolynomial *result, const int32_t N);
...
EXPORT void torusPolynomialCopyN(TorusPolynomial *result, const TorusPolynomial *sample, const int32_t N);
...
EXPORT void torusPolynomialSubN(TorusPolynomial *result, const TorusPolynomial *poly1, const TorusPolynomial *poly2,
        const int32_t N);
...
#define torusPolynomialSubMulR2 torusPolynomialSubMulRFFT2 // result = poly1*poly2 - result 
